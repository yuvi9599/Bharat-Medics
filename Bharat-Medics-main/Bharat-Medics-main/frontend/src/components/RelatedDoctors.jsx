...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626]'>
            <p className='section-kicker'>More options</p>
            <h1 className='section-title'>Related Doctors</h1>
            <p className='section-copy sm:w-1/2 text-center'>Other specialists you may want to compare before booking.</p>
